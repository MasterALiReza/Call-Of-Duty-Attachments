...
class BaseUserHandler:
    ...
    def _make_two_column_keyboard(
        self,
        items,
        callback_prefix,
        add_back_button=True,
        back_callback="categories",
        lang: str = "fa",
    ):
    ...
    def _make_mode_selection_keyboard(self, callback_prefix: str, lang: str):
        ...
        keyboard = [
            [
                InlineKeyboardButton(
                    t("mode.br_btn", lang), callback_data=f"{callback_prefix}br"
                )
            ],
            [
                InlineKeyboardButton(
                    t("mode.mp_btn", lang), callback_data=f"{callback_prefix}mp"
                )
            ],
        ]
        return keyboard
