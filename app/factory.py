...
class BotApplicationFactory:
    ...
    ⚠️ این کلاس setup_handlers() را از OX_LOADOUTAttachmentsBot جدا می‌کند
    ...
    def __init__(self, bot_instance):
        """
        Args:
            bot_instance: Instance of OX_LOADOUTAttachmentsBot
        """
    ...
    def setup_handlers(self):
        ...
        if not self.application:
            raise RuntimeError(
                "Application must be created first. Call create_application()"
            )
